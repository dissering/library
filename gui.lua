...
do
	...
	local Themes = {
        ["Preset"] = {
            ["Window Outline"] = FromRGB(10, 10, 12),
            ["Accent"] = FromRGB(255, 255, 255),
            ["Background 1"] = FromRGB(20, 20, 23),
            ["Text"] = FromRGB(255, 255, 255),
            ["Inline"] = FromRGB(27, 27, 30),
            ["Element"] = FromRGB(35, 35, 38),
            ["Inactive Text"] = FromRGB(150, 150, 155),
            ["Border"] =  FromRGB(45, 45, 48),
            ["Background 2"] = FromRGB(27, 27, 30)
        }
	}
